...
public class InsertUser extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        reg.setName(request.getParameter("names"));
        reg.setPassword(request.getParameter("newpassword"));
        reg.setContact(Long.parseLong(request.getParameter("mobile")));
        try {
            RegistrationDao.insertData(reg,db);
